...
func createTranslationMap() map[string]map[string]string {
	...
	nestedLang["tr"] = map[string]string{
		...
		"SPLIT":       "AYIR",
		"JOIN":        "BIRLESTIR",
		"FILEEXISTS":  "DOSYAVARMI",
		"FILEREAD":    "DOSYAOKU",
		"FILESIZE":    "DOSYABOYU",
		"STACKHAS":    "LISTEDEVARMI",
		"STACKGET":    "LISTEDENAL",
		"STACKSET":    "LISTEYEKOY",
		"STACKDELETE": "LISTEDENSIL",
		"STACKKEYS":   "LISTEANAHTARLARI",
		"STACKLEN":    "LISTEUZUNLUK",
		"MIN":         "MIN",
		"MAX":         "MAX",
		"ASSIGN":      "ATAMA",
		"EXEC":        "CALISTIR",
	...
	nestedLang["fi"] = map[string]string{
		...
		"SPLIT":       "JAA",
		"JOIN":        "YHDISTA",
		"FILEEXISTS":  "ONKOTIEDOSTO",
		"FILEREAD":    "LUETIEDOSTO",
		"FILESIZE":    "TIEDOSTONKOKO",
		"STACKHAS":    "ONKOLISTASSA",
		"STACKGET":    "HAELISTASTA",
		"STACKSET":    "LAITALISTAAN",
		"STACKDELETE": "POISTALISTASTA",
		"STACKKEYS":   "LISTANAVAIMET",
		"STACKLEN":    "LISTANPITUUS",
		"MIN":         "MIN",
		"MAX":         "MAX",
		"ASSIGN":      "ASETA",
		"EXEC":        "SUORITA",
	...
	nestedLang["de"] = map[string]string{
		...
		"SPLIT":       "TEILE",
		"JOIN":        "VERBINDE",
		"FILEEXISTS":  "GIBTSDATEI",
		"FILEREAD":    "LIESDATEI",
		"FILESIZE":    "DATEIGROESSE",
		"STACKHAS":    "LISTEHAT",
		"STACKGET":    "LISTEHOL",
		"STACKSET":    "LISTESETZ",
		"STACKDELETE": "LISTELOESCH",
		"STACKKEYS":   "LISTESCHLUESSEL",
		"STACKLEN":    "LISTENLAENGE",
		"MIN":         "MIN",
		"MAX":         "MAX",
		"ASSIGN":      "SETZE",
		"EXEC":        "FUEHREAUS",
